    ...
    try {
        this.coCheckNetworkAvaliable(false, function(retval) {
                                     ...
                                     msgTitle = resources.connError;
                                         ...
                                         $("#addbutton").html("<div id='coAddHelpdeskIssue350' class='closeTAPs' style='padding: 10px;text-align: center;background-color: #55c7a6 !important;color: black;margin: 11px;width: 17%;margin-left: 36%;' data-dismiss='modal'>" + msgBtnValue + "</div>");

                                         modal.style.display = "block";
                                         $(document).off("vclick", "#coAddHelpdeskIssue350");
                                         $(document).on("vclick", "#coAddHelpdeskIssue350", function (event) {
    ...
    try {
        this.coCheckNetworkAvaliable(false, function(retval) {
                                     ...
                                     msgTitle = resources.connError;
                                         ...
                                         $("#boxTitle").html(msgTitle);
                                         $("#box-string").html(msgStr);
                                         $("#addbutton").html("<div id='coUpdateHelpdeskIssue395' class='closeTAPs' style='padding: 10px;text-align: center;background-color: #55c7a6 !important;color: black;margin: 11px;width: 17%;margin-left: 36%;' data-dismiss='modal'>" + msgBtnValue + "</div>");

                                         modal.style.display = "block";
                                         $(document).off("vclick", "#coUpdateHelpdeskIssue395");
                                         $(document).on("vclick", "#coUpdateHelpdeskIssue395", function (event) {
                                             modal.style.display = "none";
                                             connectionError();
                                         });
                                     //navigator.notification.confirm(msgStr, connectionError, msgTitle, msgBtnValue);
    ...
    try {
        this.coCheckNetworkAvaliable(false, function(retval) {
                                     ...
                                     msgTitle = resources.connError;
                                         ...
                                         $("#boxTitle").html(msgTitle);
                                         $("#box-string").html(msgStr);
                                         $("#addbutton").html("<div id='coAddHelpdeskComment434' class='closeTAPs' style='padding: 10px;text-align: center;background-color: #55c7a6 !important;color: black;margin: 11px;width: 17%;margin-left: 36%;' data-dismiss='modal'>" + msgBtnValue + "</div>");

                                         modal.style.display = "block";
                                         $(document).off("vclick", "#coAddHelpdeskComment434");
                                         $(document).on("vclick", "#coAddHelpdeskComment434", function (event) {
                                             modal.style.display = "none";
                                             connectionError();
                                         });
                                     //navigator.notification.confirm(msgStr, connectionError, msgTitle, msgBtnValue);
    ...
    try {
        this.coCheckNetworkAvaliable(false, function(retval) {
                                     ...
                                     msgTitle = resources.connError;
                                         ...
                                         $("#boxTitle").html(msgTitle);
                                         $("#box-string").html(msgStr);
                                         $("#addbutton").html("<div id='coDeleteHelpdeskFile472' class='closeTAPs' style='padding: 10px;text-align: center;background-color: #55c7a6 !important;color: black;margin: 11px;width: 17%;margin-left: 36%;' data-dismiss='modal'>" + msgBtnValue + "</div>");

                                         modal.style.display = "block";
                                         $(document).off("vclick", "#coDeleteHelpdeskFile472");
                                         $(document).on("vclick", "#coDeleteHelpdeskFile472", function (event) {
                                             modal.style.display = "none";
                                             connectionError();
                                         });
                                     //navigator.notification.confirm(msgStr, connectionError, msgTitle, msgBtnValue);
    ...
    try {
        this.coCheckNetworkAvaliable(false, function(retval) {
                                     ...
                                     msgTitle = resources.connError;
                                         ...
                                         $("#boxTitle").html(msgTitle);
                                         $("#box-string").html(msgStr);
                                         $("#addbutton").html("<div id='coUploadHelpdeskFile510' class='closeTAPs' style='padding: 10px;text-align: center;background-color: #55c7a6 !important;color: black;margin: 11px;width: 17%;margin-left: 36%;' data-dismiss='modal'>" + msgBtnValue + "</div>");

                                         modal.style.display = "block";
                                         $(document).off("vclick", "#coUploadHelpdeskFile510");
                                         $(document).on("vclick", "#coUploadHelpdeskFile510", function (event) {
                                             modal.style.display = "none";
                                             connectionError();
                                         });
                                     //navigator.notification.confirm(msgStr, connectionError, msgTitle, msgBtnValue);
    ...
    try {
        this.coCheckNetworkAvaliable(false, function(retval) {
                                     ...
                                     msgTitle = resources.connError;
                                         ...
                                         $("#boxTitle").html(msgTitle);
                                         $("#box-string").html(msgStr);
                                         $("#addbutton").html("<div id='coDownloadHelpdeskFile547' class='closeTAPs' style='padding: 10px;text-align: center;background-color: #55c7a6 !important;color: black;margin: 11px;width: 17%;margin-left: 36%;' data-dismiss='modal'>" + msgBtnValue + "</div>");

                                         modal.style.display = "block";
                                         $(document).off("vclick", "#coDownloadHelpdeskFile547");
                                         $(document).on("vclick", "#coDownloadHelpdeskFile547", function (event) {
                                             modal.style.display = "none";
                                             connectionError();
                                         });
                                     //navigator.notification.confirm(msgStr, connectionError, msgTitle, msgBtnValue);
    ...
    try {
        this.coCheckNetworkAvaliable(false, function(retval) {
                                     ...
                                     msgTitle = resources.connError;
                                         ...
                                         $("#boxTitle").html(msgTitle);
                                         $("#box-string").html(msgStr);
                                         $("#addbutton").html("<div id='coDownloadHelpdeskImageFile586' class='closeTAPs' style='padding: 10px;text-align: center;background-color: #55c7a6 !important;color: black;margin: 11px;width: 17%;margin-left: 36%;' data-dismiss='modal'>" + msgBtnValue + "</div>");

                                         modal.style.display = "block";
                                         $(document).off("vclick", "#coDownloadHelpdeskImageFile586");
                                         $(document).on("vclick", "#coDownloadHelpdeskImageFile586", function (event) {
                                             modal.style.display = "none";
                                             connectionError();
                                         });
                                     //navigator.notification.confirm(msgStr, connectionError, msgTitle, msgBtnValue);
    ...
    try {
        this.coCheckNetworkAvaliable(false, function(retval) {
                                     ...
                                     msgTitle = resources.connError;
                                         ...
                                         $("#boxTitle").html(msgTitle);
                                         $("#box-string").html(msgStr);
                                         $("#addbutton").html("<div id='coUpdateSCOStatus624' class='closeTAPs' style='padding: 10px;text-align: center;background-color: #55c7a6 !important;color: black;margin: 11px;width: 17%;margin-left: 36%;' data-dismiss='modal'>" + msgBtnValue + "</div>");

                                         modal.style.display = "block";
                                         $(document).off("vclick", "#coUpdateSCOStatus624");
                                         $(document).on("vclick", "#coUpdateSCOStatus624", function (event) {
                                             modal.style.display = "none";
                                             connectionError();
                                         });
                                     //navigator.notification.confirm(msgStr, connectionError, msgTitle, msgBtnValue);
    ...
    try {
        this.coCheckNetworkAvaliable(false, function(retval) {
                                     ...
                                     msgTitle = resources.connError;
                                         ...
                                         $("#boxTitle").html(msgTitle);
                                         $("#box-string").html(msgStr);
                                         $("#addbutton").html("<div id='coUpdateModuleStatus662' class='closeTAPs' style='padding: 10px;text-align: center;background-color: #55c7a6 !important;color: black;margin: 11px;width: 17%;margin-left: 36%;' data-dismiss='modal'>" + msgBtnValue + "</div>");

                                         modal.style.display = "block";
                                         $(document).off("vclick", "#coUpdateModuleStatus662");
                                         $(document).on("vclick", "#coUpdateModuleStatus662", function (event) {
                                             modal.style.display = "none";
                                             connectionError();
                                         });
                                     //navigator.notification.confirm(msgStr, connectionError, msgTitle, msgBtnValue);
    ...
    try {
        this.coCheckNetworkAvaliable(false, function(retval) {
                                     ...
                                     msgTitle = resources.connError;
                                         ...
                                         $("#boxTitle").html(msgTitle);
                                         $("#box-string").html(msgStr);
                                         $("#addbutton").html("<div id='coUpdateCourseStatus700' class='closeTAPs' style='padding: 10px;text-align: center;background-color: #55c7a6 !important;color: black;margin: 11px;width: 17%;margin-left: 36%;' data-dismiss='modal'>" + msgBtnValue + "</div>");

                                         modal.style.display = "block";
                                         $(document).off("vclick", "#coUpdateCourseStatus700");
                                         $(document).on("vclick", "#coUpdateCourseStatus700", function (event) {
                                             modal.style.display = "none";
                                             connectionError();
                                         });
                                     //navigator.notification.confirm(msgStr, connectionError, msgTitle, msgBtnValue);
    ...
    try {
        this.coCheckNetworkAvaliable(false, function(retval) {
                                     ...
                                     msgTitle = resources.connError;
                                         ...
                                         $("#boxTitle").html(msgTitle);
                                         $("#box-string").html(msgStr);
                                         $("#addbutton").html("<div id='coGetWorksheetData738' class='closeTAPs' style='padding: 10px;text-align: center;background-color: #55c7a6 !important;color: black;margin: 11px;width: 17%;margin-left: 36%;' data-dismiss='modal'>" + msgBtnValue + "</div>");

                                         modal.style.display = "block";
                                         $(document).off("vclick", "#coGetWorksheetData738");
                                         $(document).on("vclick", "#coGetWorksheetData738", function (event) {
                                             modal.style.display = "none";
                                             connectionError();
                                         });
                                     //navigator.notification.confirm(msgStr, connectionError, msgTitle, msgBtnValue);
