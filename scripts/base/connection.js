...
function getLoginData(getLocal, returnFunction) {
    try {
        ...
        msgTitle = resources.connError;
                ...
                $("#addbutton").html("<div id='getLoginData117' class='closeTAPs' style='padding: 10px;text-align: center;background-color: #55c7a6 !important;color: black;margin: 11px;width: 17%;margin-left: 36%;' data-dismiss='modal'>" + msgBtnValue + "</div>");

                modal.style.display = "block";
                $(document).off("vclick", "#getLoginData117");
                $(document).on("vclick", "#getLoginData117", function (event) {
        ...
        if (getLocal) {
            ...
            setTimeout(function(){
                  ...
                  if( typeof JSON.stringify(coursesResponseObj) == "undefined" ){
                      ...
                      $("#boxTitle").html(msgTitle);
                      $("#box-string").html(msgStr);
                      $("#addbutton").html("<div id='weaknetwork482' class='closeTAPs' style='padding: 10px;text-align: center;background-color: #55c7a6 !important;color: black;margin: 11px;width: 17%;margin-left: 36%;' data-dismiss='modal'>" + msgBtnValue + "</div>");

                      modal.style.display = "block";
                      $(document).off("vclick", "#weaknetwork482");
                      $(document).on("vclick", "#weaknetwork482", function (event) {
                          modal.style.display = "none";
                      });
                      //navigator.notification.confirm(msgStr, function() {}, msgTitle, msgBtnValue);
...
function uploadHelpdeskMultiImageOld(fileURL,filecount,newfileissueid){
    ...
    function onError(error) {
        ...
        $("#boxTitle").html(msgTitle);
        $("#box-string").html(msgStr);
        $("#addbutton").html("<div id='onError3156' class='closeTAPs' style='padding: 10px;text-align: center;background-color: #55c7a6 !important;color: black;margin: 11px;width: 17%;margin-left: 36%;' data-dismiss='modal'>" + msgBtnValue + "</div>");

        modal.style.display = "block";
        $(document).off("vclick", "#onError3156");
        $(document).on("vclick", "#onError3156", function (event) {
            modal.style.display = "none";
        });
...
function uploadHelpdeskMultiImage(fileURL,filecount){
    ...
    function onError(error) {
        ...
        $("#boxTitle").html(msgTitle);
        $("#box-string").html(msgStr);
        $("#addbutton").html("<div id='onError3279' class='closeTAPs' style='padding: 10px;text-align: center;background-color: #55c7a6 !important;color: black;margin: 11px;width: 17%;margin-left: 36%;' data-dismiss='modal'>" + msgBtnValue + "</div>");

        modal.style.display = "block";
        $(document).off("vclick", "#onError3279");
        $(document).on("vclick", "#onError3279", function (event) {
            modal.style.display = "none";
        });
          /*navigator.notification.confirm(msgStr, function() {
                                         //hidePleaseWait();
...
function downloadHDImages(fileName, downloadIssueid){
    ...
    function(entry) {
        ...
        $("#boxTitle").html(msgTitle);
        $("#box-string").html(msgStr);
        $("#addbutton").html("<div id='downloadHDImages3362' class='closeTAPs' style='padding: 10px;text-align: center;background-color: #55c7a6 !important;color: black;margin: 11px;width: 17%;margin-left: 36%;' data-dismiss='modal'>" + msgBtnValue + "</div>");

        modal.style.display = "block";
        $(document).off("vclick", "#downloadHDImages3362");
        $(document).on("vclick", "#downloadHDImages3362", function (event) {
            modal.style.display = "none";
        });
    ...
    function(error) {
        ...
        $("#boxTitle").html(msgTitle);
        $("#box-string").html(msgStr);
        $("#addbutton").html("<div id='downloadHDImages3396' class='closeTAPs' style='padding: 10px;text-align: center;background-color: #55c7a6 !important;color: black;margin: 11px;width: 17%;margin-left: 36%;' data-dismiss='modal'>" + msgBtnValue + "</div>");

        modal.style.display = "block";
        $(document).off("vclick", "#downloadHDImages3396");
        $(document).on("vclick", "#downloadHDImages3396", function (event) {
            modal.style.display = "none";
        });
...
function updateCourseStatus(getLocal,courseid,coursestatusid,returnFunction){
    try {
            var urlMethod = getBaseUrl();
...
function getAvialbleDates(getLocal,courseId,tapId,acId,returnFunction) {
    try {
        ...
        console.log(urlMethod +"  ----   "+activeUser.userId);
        $.ajax({
            beforeSend: function() {   $("#viewDatesPage").append(mloadingGif); },
            complete: function() {  $("#mloader").remove();  },
            url: urlMethod,
            dataType: "json",
            type: "GET",
