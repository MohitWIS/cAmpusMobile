...
save: function(user) {
    try {
        ...
        if (user.AddCourseUrl != undefined) {
            user.AddCourseUrl = user.AddCourseUrl;
        }
        ...
        if (foundFiles === false && filesTable.length > 0 && resetDownload === false) {
            ...
            getLocalStorage(filesTable, function(data) {
                            ...
                            msgTitle = resources.connError;
                                ...
                                $("#addbutton").html("<div id='getStoredFilesListAsync' class='closeTAPs' style='padding: 10px;text-align: center;background-color: #55c7a6 !important;color: black;margin: 11px;width: 17%;margin-left: 36%;' data-dismiss='modal'>" + msgBtnValue + "</div>");

                                modal.style.display = "block";
                                $(document).off("vclick", "#getStoredFilesListAsync");
                                $(document).on("vclick", "#getStoredFilesListAsync", function (event) {
    ...
    try {
        ...
        coController.coGetHelpdeskIssues(function(ret) {
                                         ...
                                         msgTitle = resources.connError;
                                             ...
                                             $("#boxTitle").html(msgTitle);
                                             $("#box-string").html(msgStr);
                                             $("#addbutton").html("<div id='setUserIssues' class='closeTAPs' style='padding: 10px;text-align: center;background-color: #55c7a6 !important;color: black;margin: 11px;width: 17%;margin-left: 36%;' data-dismiss='modal'>" + msgBtnValue + "</div>");

                                             modal.style.display = "block";
                                             $(document).off("vclick", "#setUserIssues");
                                             $(document).on("vclick", "#setUserIssues", function (event) {
                                                 modal.style.display = "none";
                                                 hidePleaseWait();
                                                 returnFunction("");
                                             });
    ...
    try {
        ...
        coController.coAddHelpdeskIssue(projectId, issueTitle, issueCategoryId, comment, function(ret) {
                                        ...
                                        msgTitle = resources.connError;
                                            ...
                                            $("#boxTitle").html(msgTitle);
                                            $("#box-string").html(msgStr);
                                            $("#addbutton").html("<div id='addUserIssue927' class='closeTAPs' style='padding: 10px;text-align: center;background-color: #55c7a6 !important;color: black;margin: 11px;width: 17%;margin-left: 36%;' data-dismiss='modal'>" + msgBtnValue + "</div>");

                                            modal.style.display = "block";
                                            $(document).off("vclick", "#addUserIssue927");
                                            $(document).on("vclick", "#addUserIssue927", function (event) {
                                                modal.style.display = "none";
                                                hidePleaseWait();
                                                returnFunction(0);
                                            });
            ...
            if (podList !== undefined && podList.length > 0) {
                ...
                coController.coUserPodcastsGet(courseid, function(ret) {
                                               ...
                                               msgTitle = resources.connError;
                                                   ...
                                                   $("#boxTitle").html(msgTitle);
                                                   $("#box-string").html(msgStr);
                                                   $("#addbutton").html("<div id='getAllUserPodcasts1206' class='closeTAPs' style='padding: 10px;text-align: center;background-color: #55c7a6 !important;color: black;margin: 11px;width: 17%;margin-left: 36%;' data-dismiss='modal'>" + msgBtnValue + "</div>");

                                                   modal.style.display = "block";
                                                   $(document).off("vclick", "#getAllUserPodcasts1206");
                                                   $(document).on("vclick", "#getAllUserPodcasts1206", function (event) {
                                                       modal.style.display = "none";
                                                       hidePleaseWait();
                                                       returnFunction(false);
                                                   });
        ...
        if (continueProcess===true) {
            ...
            coController.coVideoGroupCategoriesGet(libraryId, function(ret) {
                                                   ...
                                                   msgTitle = resources.connError;
                                                       ...
                                                       $("#boxTitle").html(msgTitle);
                                                       $("#box-string").html(msgStr);
                                                       $("#addbutton").html("<div id='getUserVideos1737' class='closeTAPs' style='padding: 10px;text-align: center;background-color: #55c7a6 !important;color: black;margin: 11px;width: 17%;margin-left: 36%;' data-dismiss='modal'>" + msgBtnValue + "</div>");

                                                       modal.style.display = "block";
                                                       $(document).off("vclick", "#getUserVideos1737");
                                                       $(document).on("vclick", "#getUserVideos1737", function (event) {
                                                           modal.style.display = "none";
                                                           hidePleaseWait();
                                                           returnFunction("");
                                                       });
        ...
        if (videoId > 0) {
            coController.coVideoViewsUpdate(videoId, function(ret) {
                                            ...
                                            msgTitle = resources.connError;
                                                ...
                                                $("#boxTitle").html(msgTitle);
                                                $("#box-string").html(msgStr);
                                                $("#addbutton").html("<div id='updateVideoViews2235' class='closeTAPs' style='padding: 10px;text-align: center;background-color: #55c7a6 !important;color: black;margin: 11px;width: 17%;margin-left: 36%;' data-dismiss='modal'>" + msgBtnValue + "</div>");

                                                modal.style.display = "block";
                                                $(document).off("vclick", "#updateVideoViews2235");
                                                $(document).on("vclick", "#updateVideoViews2235", function (event) {
                                                    modal.style.display = "none";
                                                    hidePleaseWait();
                                                    returnFunction("");
                                                });
        ...
        if ((this.audiocategories === undefined || this.audiocategories.length === 0 || audioInit === true) && deviceIsOnline === true) {
            ...
            coController.coAudioGroupCategoriesGet(function(ret) {
                                                   ...
                                                   msgTitle = resources.connError;
                                                       ...
                                                       $("#boxTitle").html(msgTitle);
                                                       $("#box-string").html(msgStr);
                                                       $("#addbutton").html("<div id='getUserAudios2287' class='closeTAPs' style='padding: 10px;text-align: center;background-color: #55c7a6 !important;color: black;margin: 11px;width: 17%;margin-left: 36%;' data-dismiss='modal'>" + msgBtnValue + "</div>");

                                                       modal.style.display = "block";
                                                       $(document).off("vclick", "#getUserAudios2287");
                                                       $(document).on("vclick", "#getUserAudios2287", function (event) {
                                                           modal.style.display = "none";
                                                           hidePleaseWait();
                                                           returnFunction("");
                                                       });
...
addUserPlaylist: function(playlistTitle, returnFunction){
    try {
        ...
        if (addPL === false){
            ...
            $("#boxTitle").html(msgTitle);
            $("#box-string").html(msgStr);
            $("#addbutton").html("<div id='addUserPlaylist2701' class='closeTAPs' style='padding: 10px;text-align: center;background-color: #55c7a6 !important;color: black;margin: 11px;width: 17%;margin-left: 36%;' data-dismiss='modal'>" + msgBtnValue + "</div>");

            modal.style.display = "block";
            $(document).off("vclick", "#addUserPlaylist2701");
            $(document).on("vclick", "#addUserPlaylist2701", function (event) {
                modal.style.display = "none";
                returnFunction(false);
            });
    ...
    try {
        if(playlistTracks!==undefined && playlistTracks.length ===0){
            ...
            for (var n = 0; n < this.audiocategories.length; n++) {
                ...
                if (categoryGroup.audiocategories != undefined && categoryGroup.audiocategories.length > 0) {
                    listStr += "<div style='background-color:#F4EEEA !important;' class='tracksuldiv'><ul class='pltrackscategory' data-theme='h' data-role='listview' data-inset='true'>";
    ...
    try {
        ...
        coController.coAddHelpdeskComment(projectId, issueId, issueTitle, issueCategoryId, comment, function(ret) {
                                          ...
                                          msgTitle = resources.connError;
                                              ...
                                              $("#boxTitle").html(msgTitle);
                                              $("#box-string").html(msgStr);
                                              $("#addbutton").html("<div id='addIssueComment3401' class='closeTAPs' style='padding: 10px;text-align: center;background-color: #55c7a6 !important;color: black;margin: 11px;width: 17%;margin-left: 36%;' data-dismiss='modal'>" + msgBtnValue + "</div>");

                                              modal.style.display = "block";
                                              $(document).off("vclick", "#addIssueComment3401");
                                              $(document).on("vclick", "#addIssueComment3401", function (event) {
                                                  modal.style.display = "none";
                                                  hidePleaseWait();
                                                  returnFunction(false);
                                              });
    ...
    try {
        ...
        coController.coDeleteHelpdeskFile(issueId, fileId, function(ret) {
                                          ...
                                          msgTitle = resources.connError;
                                              ...
                                              $("#boxTitle").html(msgTitle);
                                              $("#box-string").html(msgStr);
                                              $("#addbutton").html("<div id='deleteIssueFile3458' class='closeTAPs' style='padding: 10px;text-align: center;background-color: #55c7a6 !important;color: black;margin: 11px;width: 17%;margin-left: 36%;' data-dismiss='modal'>" + msgBtnValue + "</div>");

                                              modal.style.display = "block";
                                              $(document).off("vclick", "#deleteIssueFile3458");
                                              $(document).on("vclick", "#deleteIssueFile3458", function (event) {
                                                  modal.style.display = "none";
                                                  hidePleaseWait();
                                                  returnFunction(false);
                                              });
    ...
    try {
        ...
        coController.coUploadHelpdeskFile(this.issueid, fileName, fileSize, fileType, fileData, function(ret) {
                                          ...
                                          msgTitle = resources.connError;
                                              ...
                                              $("#boxTitle").html(msgTitle);
                                              $("#box-string").html(msgStr);
                                              $("#addbutton").html("<div id='addIssueFile3515' class='closeTAPs' style='padding: 10px;text-align: center;background-color: #55c7a6 !important;color: black;margin: 11px;width: 17%;margin-left: 36%;' data-dismiss='modal'>" + msgBtnValue + "</div>");

                                              modal.style.display = "block";
                                              $(document).off("vclick", "#addIssueFile3515");
                                              $(document).on("vclick", "#addIssueFile3515", function (event) {
                                                  modal.style.display = "none";
                                                  hidePleaseWait();
                                                  returnFunction(false);
                                              });
    ...
    try {
        ...
        coController.coDownloadHelpdeskImageFile(issueid, fileId, function(ret) {
                                                 ...
                                                 msgTitle = resources.connError;
                                                     ...
                                                     $("#boxTitle").html(msgTitle);
                                                     $("#box-string").html(msgStr);
                                                     $("#addbutton").html("<div id='downloadHelpdeskImageFile3570' class='closeTAPs' style='padding: 10px;text-align: center;background-color: #55c7a6 !important;color: black;margin: 11px;width: 17%;margin-left: 36%;' data-dismiss='modal'>" + msgBtnValue + "</div>");

                                                     modal.style.display = "block";
                                                     $(document).off("vclick", "#downloadHelpdeskImageFile3570");
                                                     $(document).on("vclick", "#downloadHelpdeskImageFile3570", function (event) {
                                                         modal.style.display = "none";
                                                         hidePleaseWait();
                                                         returnFunction(false);
                                                     });
    ...
    try {
        ...
        coController.coDownloadHelpdeskFile(issueid, fileId, function(ret) {
                                            ...
                                            msgTitle = resources.connError;
                                                ...
                                                $("#boxTitle").html(msgTitle);
                                                $("#box-string").html(msgStr);
                                                $("#addbutton").html("<div id='downloadHelpdeskFile3622' class='closeTAPs' style='padding: 10px;text-align: center;background-color: #55c7a6 !important;color: black;margin: 11px;width: 17%;margin-left: 36%;' data-dismiss='modal'>" + msgBtnValue + "</div>");

                                                modal.style.display = "block";
                                                $(document).off("vclick", "#downloadHelpdeskFile3622");
                                                $(document).on("vclick", "#downloadHelpdeskFile3622", function (event) {
                                                    modal.style.display = "none";
                                                    hidePleaseWait();
                                                    returnFunction(false);
                                                });
