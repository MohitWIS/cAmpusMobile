               ...
               mediaListSet.then(function() {
                                 activeUser.getStoredFilesListAsync("eclasses", mediaInit, function(retVal) {
                                                                    ...
                                                                    msgTitle = resources.connError;
                                                                        ...
                                                                        $("#addbutton").html("<div id='eclassvideopage118' class='closeTAPs' style='padding: 10px;text-align: center;background-color: #55c7a6 !important;color: black;margin: 11px;width: 17%;margin-left: 36%;' data-dismiss='modal'>" + msgBtnValue + "</div>");

                                                                        modal.style.display = "block";
                                                                        $(document).off("vclick", "#eclassvideopage118");
                                                                        $(document).on("vclick", "#eclassvideopage118", function (event) {
...
function setPlayEclassBtn() {
    ...
    $(".playeclassbtn").on("vclick", function(event) {
                           ...
                           msgTitle = resources.connError;
                               ...
                               $("#boxTitle").html(msgTitle);
                               $("#box-string").html(msgStr);
                               $("#addbutton").html("<div id='setPlayEclassBtn' class='closeTAPs' style='padding: 10px;text-align: center;background-color: #55c7a6 !important;color: black;margin: 11px;width: 17%;margin-left: 36%;' data-dismiss='modal'>" + msgBtnValue + "</div>");

                               modal.style.display = "block";
                               $(document).off("vclick", "#setPlayEclassBtn");
                               $(document).on("vclick", "#setPlayEclassBtn", function (event) {
                                   modal.style.display = "none";
                               });
...
function setDownloadEclassBtn() {
    ...
    $(".downloadeclassbtn").on("vclick", function(event) {
                               ...
                               msgTitle = resources.connError;
                                   ...
                                   $("#boxTitle").html(msgTitle);
                                   $("#box-string").html(msgStr);
                                   $("#addbutton").html("<div id='setDownloadEclassBtn' class='closeTAPs' style='padding: 10px;text-align: center;background-color: #55c7a6 !important;color: black;margin: 11px;width: 17%;margin-left: 36%;' data-dismiss='modal'>" + msgBtnValue + "</div>");

                                   modal.style.display = "block";
                                   $(document).off("vclick", "#setDownloadEclassBtn");
                                   $(document).on("vclick", "#setDownloadEclassBtn", function (event) {
                                       modal.style.display = "none";
                                   });
                               //navigator.notification.confirm(msgStr, function() {}, msgTitle, msgBtnValue);
                               } else {
...
function setDownloadAllEclassesBtn() {
    ...
    $(".downloadalleclassbtn").on("vclick", function(event) {
                                  ...
                                  msgTitle = resources.connError;
                                      ...
                                      $("#boxTitle").html(msgTitle);
                                      $("#box-string").html(msgStr);
                                      $("#addbutton").html("<div id='setDownloadAllEclassesBtn651' class='closeTAPs' style='padding: 10px;text-align: center;background-color: #55c7a6 !important;color: black;margin: 11px;width: 17%;margin-left: 36%;' data-dismiss='modal'>" + msgBtnValue + "</div>");

                                      modal.style.display = "block";
                                      $(document).off("vclick", "#setDownloadAllEclassesBtn651");
                                      $(document).on("vclick", "#setDownloadAllEclassesBtn651", function (event) {
                                          modal.style.display = "none";
                                      });
                                  //navigator.notification.confirm(msgStr, function() {}, msgTitle, msgBtnValue);
                                  } else {
                                  ...
                                  msgTitle = resources.myvideos;
                                      ...
                                      $("#boxTitle").html(msgTitle);
                                      $("#box-string").html(msgStr);
                                      $("#addbutton").html("<div id='setDownloadAllEclassesBtn675' class='closeTAPs' style='padding: 10px;text-align: center;background-color: #55c7a6 !important;color: black;margin: 11px;width: 17%;margin-left: 36%;' data-dismiss='modal'>" + msgBtnValue + "</div>");

                                      modal.style.display = "block";
                                      $(document).off("vclick", "#setDownloadAllEclassesBtn675");
                                      $(document).on("vclick", "#setDownloadAllEclassesBtn675", function (event) {
                                          modal.style.display = "none";
